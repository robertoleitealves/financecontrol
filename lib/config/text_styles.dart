...
class TextStyles {
  ...
  TextStyle get textTitle => textExtraBold.copyWith(fontSize: 26);

  TextStyle get textSubtitle => textBold.copyWith(fontSize: 18);

  TextStyle get textBody => textRegular.copyWith(fontSize: 16);
}
