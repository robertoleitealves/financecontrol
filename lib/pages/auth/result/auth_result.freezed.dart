...
class __$$SucessCopyWithImpl<T, $Res>
    extends _$AuthResultCopyWithImpl<T, $Res, _$Sucess<T>>
...
class _$Sucess<T> implements Sucess<T> {
  ...
  @override
  String toString() {
    return 'AuthResult<$T>.success(response: $response)';
  }
...
abstract class Sucess<T> implements AuthResult<T> {
  factory Sucess(final T response) = _$Sucess<T>;
